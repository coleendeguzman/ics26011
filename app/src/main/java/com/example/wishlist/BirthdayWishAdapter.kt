...
class BirthdayWishAdapter(private var wishes: List<Wishes>, context: Context) : RecyclerView.Adapter<BirthdayWishAdapter.WishViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): WishViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.birthday_wish, parent, false)
